...
public class SeriesParse {
	...
	private String url = "http://all.wasu.cn/index/sort/time/cid/11/class/program?p={page}";
	...
	public void getDetail() {
		String url = "http://www.wasu.cn/Agginfo/index/id/114768";
		detail(url);
	}
	...
	public void getTotalPage() {
		for (int i = 1; i > 0; i++) {
			...
			if (next_page.attr("href") == null || "".equals(next_page.attr("href"))) {
				...
				int total = Integer.parseInt(last_page.text());
